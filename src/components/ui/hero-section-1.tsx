              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <h1 className="mx-auto mt-8 max-w-4xl text-balance text-6xl font-bold text-foreground md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                    Modern Solutions for AI Trading
                  </h1>
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                    Highly customizable AI bot for automated trading. Signals,
                    backtesting, and execution in one platform.
                  </p>
                </AnimatedGroup>
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(to bottom, transparent 0%, transparent 35%, hsl(var(--background)) 100%)',
                  }}
                />
                <div className="ring-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border border-border bg-background p-4 shadow-lg ring-1">
                  <img
                    className="relative aspect-video rounded-2xl bg-background object-cover"
            ...
            <div className="mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
              {[
                ...
                <div key={i} className="flex">
                  <div className="mx-auto h-8 w-12 rounded bg-muted" title={`Logo ${i + 1}`} />
                </div>
              ))}
            </div>
          </div>
